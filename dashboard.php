...
<head>
	...
	<title>Socopacrm Admin Dashboard</title>
	<!-- Font awesome -->
...
$bg1=$query->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bg1);?></div>
													<div class="stat-panel-title text-uppercase">Reasons</div>
												</div>
											</div>
											<a href="reasons.php" class="block-anchor panel-footer text-center">View Reasons &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>

<!-- Start of Outcomes sections -->
<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
...
?>
													...
													<div class="stat-panel-title text-uppercase">Outcomes</div>
												</div>
											</div>
											<a href="outcomes.php" class="block-anchor panel-footer text-center">View Outcomes &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>

<!-- Start of Referrals sections -->
<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($regbd);?></div>
													<div class="stat-panel-title text-uppercase">Referrals</div>
												</div>
											</div>
											<a href="referrals.php" class="block-anchor panel-footer text-center">View Referrals &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
<!-- Start of Client Requests sections -->
				<div class="col-md-3">
										<div class="panel panel-default">
...
$regbd=$query->rowCount();
?>												<div class="stat-panel-number h1 "><?php echo htmlentities($regbd);?></div>
													<div class="stat-panel-title text-uppercase">Client Requests</div>
												</div>
											</div>
											<a href="requests.php" class="block-anchor panel-footer text-center">View Requests &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
