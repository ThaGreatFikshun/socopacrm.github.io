					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap" id="msgshow"><?php echo htmlentities($error); ?> </div><?php } 
								...
								<button><a href="register.php?edit=<?php echo $result->id;?>" onclick="return confirm('Do you want to Add');">&nbsp; Add Customer<i class="fa fa-user-plus"></i></a>&nbsp;&nbsp;</button>
...
{				?>	
										<tr>
											...
											<td><?php  echo htmlentities($result->empstatus);?></td>
											<td><?php  echo htmlentities($result->accneeds);?></td>
