...
<head>
	...
	<title>Socopa Edit Customer</title>
...
<label class="col-sm-2 control-label">Surname<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="surname" class="form-control" required value="<?php echo htmlentities($result->surname);?>">
</div><br><br>
...
<label class="col-sm-2 control-label">PostalCode<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="postalcode" class="form-control" required value="<?php echo htmlentities($result->postalcode);?>">
</div><br><br>
<label class="col-sm-2 control-label">Emp Status<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="empstatus" class="form-control" required value="<?php echo htmlentities($result->empstatus);?>">
</div><br>
<label class="col-sm-2 control-label">Account Needs<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="accneeds" class="form-control" required value="<?php echo htmlentities($result->accneeds);?>">
</div><br>
<label class="col-sm-2 control-label">Requests<span style="color:red"></span></label>
<div class="col-sm-4">
<input type="text" name="requests" class="form-control" required value="<?php echo htmlentities($result->requests);?>">
</div><br>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Outcome<span style="color:red"></span></label>
<div class="col-sm-4">
<input type="text" name="outcome" class="form-control" required value="<?php echo htmlentities($result->outcome);?>">
</div><br>
<label class="col-sm-2 control-label">Referrals<span style="color:red"></span></label>
<div class="col-sm-4">
<input type="text" name="referrals" class="form-control" required value="<?php echo htmlentities($result->referrals);?>">
</div><br>
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		<button class="btn btn-primary" name="submit" type="submit">Saved Successfully</button>
	</div>
</div>
